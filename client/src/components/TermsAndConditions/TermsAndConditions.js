...
const TermsAndConditions = () => {
  return (
    <React.Fragment>
      <h2 style={{ padding: "20px 0px 0px 20px" }}>Terms and Conditions</h2>
      <div style={{ padding: 40 }}>
        ...
        Conditions. This Website is not for use by any minors (defined as those
        who are not at least 18 years of age), and you must not use this Website
        if you a minor.
        <br />
        <br />
        ...
        Website, under these Terms , and/or its licensors own all rights to the
        intellectual property and material contained in this Website, and all
        such rights are reserved. You are granted a limited license only,
        ...
        publishing any Website material in any media; selling, sub-licensing
        and/or otherwise commercializing any Website material; publicly
        performing and/or showing any Website material; using this Website in
        any way that is, or may be, damaging to this Website; using this Website
        in any way that impacts user access to this Website; using this Website
        contrary to applicable laws and regulations, or in a way that causes, or
        ...
        Website; using this Website to engage in any advertising or marketing;
        Certain areas of this Website are restricted from access by you and
        PRIDE COMMERCE ACADEMY may further restrict access by you to any areas
        of this Website, at any time, in its sole and absolute discretion. Any
        user ID and password you may have for this Website are confidential and
        ...
        display on this Website. With respect to Your Content, by displaying it,
        you grant PRIDE COMMERCE ACADEMY a non-exclusive, worldwide,
        ...
        rights. PRIDE COMMERCE ACADEMY reserves the right to remove any of Your
        ...
        <b>5. No warranties</b>
        <br />
        This Website is provided “as is,” with all faults, and PRIDE COMMERCE
        ACADEMY makes no express or implied representations or warranties, of
        ...
        <br />
        In no event shall PRIDE COMMERCE ACADEMY , nor any of its officers,
        ...
        liability is under contract, tort or otherwise, and PRIDE COMMERCE
        ACADEMY , including its officers, directors and employees shall not be
        ...
        <br />
        You hereby indemnify to the fullest extent PRIDE COMMERCE ACADEMY from
        and against any and all liabilities, costs, demands, causes of action,
        ...
        <br />
        <br />
        <b>9. Variation of Terms</b> <br />
        PRIDE COMMERCE ACADEMY is permitted to revise these Terms at any time as
        it sees fit, and by using this Website you are expected to review such
        ...
        <b>10. Assignment</b>
        <br />
        PRIDE COMMERCE ACADEMY shall be permitted to assign, transfer, and
        ...
        this Website, constitute the entire agreement between PRIDE COMMERCE
        ACADEMY and you in relation to your use of this Website, and supersede
        ...
        laws of the State of MAHARASHTRA, and you submit to the non-exclusive
        jurisdiction of the state and federal courts located in MAHARASHTRA for
